    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            <div class="text-center mb-4">
                <!-- BEGIN NAVBAR LOGO --><a href="." class="navbar-brand navbar-brand-autodark"><svg
            ...
            <form class="card card-md" action="{{ route('password.email') }}" method="POST" autocomplete="off" novalidate>
                ...
                <div class="card-body">
                    ...
                    <div class="form-footer">
                        <button type="submit"
                            class="btn btn-primary btn-4 w-100 d-flex align-items-center justify-content-center gap-2">
                            <!-- Mail icon -->
