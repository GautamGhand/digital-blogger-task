                        ...
                        <ul class="navbar-nav">
                                ...
                                <a class="nav-link" href="{{ route('users') }}">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <g>
                                                <g>
                                                    <ellipse style="fill:#eae7ec;" cx="30.336" cy="12.097"
                                                        rx="11.997" ry="12.097" />
                                                    <path style="fill:#eae7ec;" d="M35.64,30.079H25.031c-7.021,0-12.714,5.739-12.714,12.821v17.771h36.037V42.9
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdown-menu-columns">
                                        <div class="dropdown-menu-column">
                                            ...
                                            <a class="dropdown-item" href="./cookie-banner.html"> Cookie
                                                banner </a>
                                            <a class="dropdown-item" href="./empty.html"> Empty page </a>
                                            <a class="dropdown-item" href="./faq.html"> FAQ </a>
                                            <a class="dropdown-item" href="./gallery.html"> Gallery </a>
                                            <a class="dropdown-item" href="./invoice.html"> Invoice </a>
                                            <a class="dropdown-item" href="./job-listing.html"> Job listing
                                            </a>
                                            <a class="dropdown-item" href="./license.html"> License </a>
                                            <a class="dropdown-item" href="./logs.html"> Logs </a>
                                            <a class="dropdown-item" href="./marketing/index.html"> Marketing
                                            </a>
                                            <a class="dropdown-item" href="./music.html"> Music </a>
                                            <a class="dropdown-item" href="./page-loader.html"> Page loader
                                            </a>
                                        </div>
                                        <div class="dropdown-menu-column">
                                            ...
                                            <a class="dropdown-item" href="./pricing-table.html"> Pricing
                                                table </a>
                                            <a class="dropdown-item" href="./search-results.html"> Search
                                                results </a>
                                            ...
                                            <a class="dropdown-item" href="./trial-ended.html"> Trial ended
                                            </a>
                            ...
                            <li class="nav-item active dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdown-menu-columns">
                                        <div class="dropdown-menu-column">
                                            <a class="dropdown-item active" href="./layout-boxed.html"> Boxed
                                            </a>
                                            ...
                                            <a class="dropdown-item" href="./layout-horizontal.html">
                                                Horizontal </a>
                                            <a class="dropdown-item" href="./layout-navbar-dark.html"> Navbar
                                                dark </a>
                                        </div>
                                        <div class="dropdown-menu-column">
